        ...
        <section className="py-12" id="pricing">
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-9 mt-12">
                    <div
                        className="card text-center transform transition ease-in-out duration-300 hover:-translate-y-4 mb-4 shadow-xl border border-neutral-100 p-10">
                        <div className="card-body">
                            ...
                            <hr className="my-7"></hr>
                                ...
                                <div className="space-y-5">
                                    ...
                                    <p><span className="text-red-500 font-medium">1</span> Domain</p>
                                    <p><span className="text-red-500 font-medium">No</span> Hidden Fees</p>
                                </div>
                                <button className="btn bg-red-500 text-white mt-6 btn border border-red-500 w-40 h-10">Join Now</button>
                        </div>
                    </div>
                    <div
                        className="card text-center transform transition ease-in-out duration-300 hover:-translate-y-4 shadow-xl mb-4 border border-neutral-100 p-10">
                        <div className="card-body">
                            <div className="space-y-2">
                            ...
                            <hr className="my-7"></hr>
                                ...
                                <div className="space-y-5">
                                    ...
                                    <p><span className="text-red-500 font-medium">10</span> Domain</p>
                                    <p><span className="text-red-500 font-medium">No</span> Hidden Fees</p>
                                </div>
                            <button className="btn bg-red-500 text-white mt-6 btn border border-red-500 w-40 h-10">Join Now</button>
                        </div>
                        ...
                        <div className="card-body">
                            ...
                            <hr className="my-7"></hr>
                                ...
                                <div className="space-y-5">
                                    ...
                                    <p>Support: <span className="text-red-500 font-medium">Yes</span></p>
                                    <p><span className="text-red-500 font-medium">Unlimited</span> Domain</p>
                                    <p><span className="text-red-500 font-medium">No</span> Hidden Fees</p>
                                </div>
                            <button className="btn bg-red-500 text-white mt-6 btn border border-red-500 w-40 h-10">Join Now</button>
                        </div>
